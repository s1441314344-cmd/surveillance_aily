...
if launchctl list | rg -q "com.surveillance.v2.api"; then
  launchctl bootout "gui/$(id -u)" "${TARGET_PLIST}" || true
fi
launchctl bootstrap "gui/$(id -u)" "${TARGET_PLIST}"
launchctl enable "gui/$(id -u)/com.surveillance.v2.api"
launchctl kickstart -k "gui/$(id -u)/com.surveillance.v2.api"

echo "API launchd installed and started."
